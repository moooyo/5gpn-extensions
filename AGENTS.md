...
- Run `npm test` and `npm run verify:upstreams` before delivery. When changing
  runtime-facing behavior, also validate the manifests with the current 5gpn
  core parser integration gate.
