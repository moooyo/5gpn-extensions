...
当前集成 pin 是 `moooyo/mihomo@3b089142684a6b33215537431dd652564f28f6fb`，即安装器 `v1.19.30-monolith.37` artifact 背后的源码提交。安装器升级时，必须在同一变更中更新此精确提交与 workflow。不得换成分支或可移动 tag，也不得把 `npm test` 或 marketplace 可复现性本身描述为运行时验证。
